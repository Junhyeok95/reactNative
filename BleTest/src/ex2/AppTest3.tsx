...
const App = () => {
  ...
  const _handleDiscoverPeripheral = (peripheral) => {
  ...
  const _handleUpdateValueForCharacteristic = (data) => {
    console.log('Test ~!');
    console.log(data);
    console.log('Test ~!');
    console.log('Received data from ' + data.peripheral + ' characteristic ' + data.characteristic, data.value);
  };
  const _handleDisconnectedPeripheral = (data) => {
    let _peripherals = peripherals;
    ...
    <SafeAreaView >
      <View >
        <View style={{margin: 10}}>
          <Button title="Retrieve" onPress={() => {} } />
        </View>

        <View style={{margin: 10}}>
          <Button title="Retrieve connected peripherals" onPress={() => {} } />
        </View>
